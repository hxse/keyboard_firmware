...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [5] = LAYOUT_split_3x6_3(KC_TRNS, KC_NO, KC_NO, RGB_VAI, KC_NO, RGB_TOG, KC_NO, M_curly_brackets, M_square_brackets, M_round_brackets, M_angle_brackets, KC_TRNS, KC_NO, KC_NO, RGB_RMOD, RGB_VAD, RGB_MOD, LCTL(KC_LBRC), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO, RGB_SAD, KC_NO, RGB_SAI, KC_NO, KC_NO, KC_NO, M_arrow_left, M_arrow_right, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, TO(1), TO(0), KC_TRNS)};
