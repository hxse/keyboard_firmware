...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_3x6_3(KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_ESC, KC_BSPC, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, LSFT(KC_SCLN), KC_QUOT, OSM(MOD_LALT), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_EQL, KC_LGUI, OSM(MOD_LCTL), LT(2, KC_SPC), LT(3, KC_ENT), OSL(5), LT(4, KC_ENT), KC_LSFT),
    [2] = LAYOUT_split_3x6_3(LALT(KC_TAB), LALT(LSFT(KC_F9)), LCTL(KC_LEFT), KC_UP, LCTL(KC_RGHT), KC_PGUP, KC_NO, KC_LCBR, KC_LBRC, KC_LPRN, KC_LT, KC_TRNS, KC_DEL, OSL(4), KC_LEFT, KC_DOWN, KC_RGHT, LCTL(KC_RBRC), KC_MUTE, KC_BTN1, KC_BTN3, KC_BTN2, KC_SCLN, KC_GRV, KC_LSFT, LCTL(LSFT(KC_Z)), KC_HOME, LALT(LSFT(KC_F6)), KC_END, KC_PGDN, KC_NO, KC_EXLM, KC_VOLD, KC_VOLU, KC_QUES, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LSFT(KC_ENT), KC_TRNS),
