...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_split_3x6_3(LALT(KC_TAB), KC_LALT, LCTL(KC_LEFT), KC_UP, LCTL(KC_RGHT), KC_PGUP, KC_NO, KC_LCBR, KC_LBRC, KC_LPRN, KC_LT, KC_TRNS, KC_DEL, LCTL(KC_LBRC), KC_LEFT, KC_DOWN, KC_RGHT, LCTL(KC_RBRC), KC_MUTE, KC_BTN1, KC_BTN3, KC_BTN2, KC_SCLN, KC_GRV, KC_LSFT, LCTL(LSFT(KC_Z)), KC_HOME, KC_ENT, KC_END, KC_PGDN, KC_NO, KC_EXLM, KC_VOLD, KC_VOLU, KC_QUES, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LSFT(KC_ENT), KC_TRNS),
