...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_split_3x6_3(LALT(KC_TAB), LALT(LSFT(KC_F9)), LCTL(KC_LEFT), KC_UP, LCTL(KC_RGHT), KC_PGUP, KC_NO, KC_LCBR, KC_LBRC, KC_LPRN, KC_LT, KC_TRNS, KC_DEL, LT(5, KC_ENT), KC_LEFT, KC_DOWN, KC_RGHT, LCTL(KC_RBRC), KC_MUTE, KC_BTN1, KC_BTN3, KC_BTN2, KC_SCLN, KC_GRV, KC_LSFT, LCTL(LSFT(KC_Z)), KC_HOME, LALT(LSFT(KC_F6)), KC_END, KC_PGDN, KC_NO, KC_EXLM, KC_VOLD, KC_VOLU, KC_QUES, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LSFT(KC_ENT), KC_TRNS),
    [3] = LAYOUT_split_3x6_3(LALT(KC_TAB), KC_PLUS, KC_MINS, KC_ASTR, KC_PERC, KC_AMPR, KC_PIPE, KC_RCBR, KC_RBRC, KC_RPRN, KC_GT, KC_TRNS, KC_BSPC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_DQUO, KC_TRNS, KC_AT, KC_UNDS, KC_HASH, KC_TILD, KC_CIRC, KC_DLR, KC_BSLS, KC_COMM, KC_DOT, KC_SLSH, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
    [4] = LAYOUT_split_3x6_3(LALT(KC_TAB), KC_F11, KC_F12, LALT(LSFT(KC_F3)), LALT(LSFT(KC_F4)), LALT(LSFT(KC_F5)), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, LALT(LSFT(KC_F7)), KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LALT(LSFT(KC_F8)), KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, TO(1), KC_TRNS, KC_TRNS, KC_TRNS),
