...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [5] = LAYOUT_split_3x6_3(KC_TRNS, KC_NO, KC_7, KC_8, KC_9, KC_0, KC_NO, M_curly_brackets, M_square_brackets, M_round_brackets, M_angle_brackets, KC_TRNS, KC_NO, KC_NO, KC_4, KC_5, KC_6, LCTL(KC_LBRC), RGB_TOG, RGB_VAD, RGB_VAI, RGB_SAD, RGB_SAI, KC_NO, KC_TRNS, KC_NO, KC_1, KC_2, KC_3, KC_DOT, KC_NO, KC_NO, M_arrow_left, M_arrow_right, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, TO(1), TO(0), KC_TRNS)};
